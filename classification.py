...
#3 Read and provide statistics on the dataset.
...
#4 Solutions (run the cell to get the answers)
...
#5 Create five 2D plots of the features against each other, color-coded by class.
...
#6 Plot three features in 3D by entering their names and running this cell

x_axis_data = 'Major_Axis_Length'  # @param {type: "string"}
y_axis_data = 'Minor_Axis_Length'  # @param {type: "string"}
...
#8 Calculate the Z-scores of each numerical column in the raw data and write
...
#9 Set the random seeds
keras.utils.set_random_seed(42)

#10 Create a column setting the Cammeo label to '1' and the Osmancik label to '0'
...
#11 Create indices at the 80th and 90th percentiles
...
#12 Name of the features we'll train our model on.
input_features = [
    'Eccentricity',
    'Major_Axis_Length',
    'Area',
...
#13 Define the functions that create and train a model.
...
#14 Define the plotting function.
...
#15 Let's define our first experiment settings.
settings = ExperimentSettings(
    learning_rate=0.001,
    number_epochs=60,
    batch_size=100,
...
#16 Evaluate the model against the test set
...
#18 Train the full featured model and calculate metrics
...
#19 evaluate full-featured model on test split
...
#20 Define function to compare experiments
